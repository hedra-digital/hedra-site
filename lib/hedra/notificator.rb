...
module Hedra
  class Notificator
    ...
    def send
      ...
      Mailer.send_notification(:to => transaction.order.email, :subject => subject, :template_path => 'notifications/checkout', :template_name => template_name, :order => transaction.order, :cc => 'fabricio@vizir.com.br').deliver
    end
